...
/*
 * Allow Management frames to be passed to the host
 */
...
struct wilc_wlan_oup {
	...
	int (*wlan_cfg_set)(int, uint32_t, uint8_t *,
...
enum WID_E {
	...
	/*
	 * WID to trigger modified Join Request using SSID and BSSID
	 * instead of bssListIdx (used by WID_JOIN_REQ)
	 */
	WID_JOIN_REQ_EXTENDED		= 0x3998,

	/* WID toset IP address in firmware */
	...
	/* WID to add IE to be added in next probe request*/
	WID_INFO_ELEMENT_PROBE		= 0x4085,

	/* WID to add IE to be added in next associate request*/
